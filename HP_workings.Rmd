...
p2 <- ggplot(data = hp2, aes(x=Year, y=Price, color= Desc, group= Desc))+
...
p3 <- ggplot(data = hp3, aes(x=Year, y=Price, color= Desc, group= Desc))+
  geom_line()+  geom_point()+ 
  theme(axis.text.x=element_text(angle=90, hjust=1))+
...
p4 <- ggplot(data = hp4, aes(x=Year, y=Price, color= Desc, group= Desc))+
  geom_line()+  geom_point()+ 
  theme(axis.text.x=element_text(angle=90, hjust=1))+
...
p5 <- ggplot(data = hp5, aes(x=Year, y=Price/1000, color= Desc, group= Desc))+
  geom_line()+ 

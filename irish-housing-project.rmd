...
When it comes to house buying there is a huge dilemma whether to buy a new property or a second-hand property and whether to buy it in or outside of Dublin. The adjacent <b>interactive</b> plot helps us in making this decision by understanding the trends across the last ten years.
...
```{r}
htmltools::tags$figcaption("Fig 7. Interactive plot for comparision between New and Second-hand properties between Dublin & Other Towns", style = "float:right;width: 450px; padding: 10px 0 0 0; text-align:center; ")
```
...
```{r, fig.cap="Fig. 8: Median price of property in towns based on county and region", fig.align= "center"}
...
```{r, fig.cap="Fig. 9: Rate Change over year for major towns", fig.align= "center"}
...
```{r, fig.cap="Fig. 10: Average House price vs Total sale price for four towns", fig.align= "center"}

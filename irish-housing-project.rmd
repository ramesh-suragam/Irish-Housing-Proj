...
```{r, fig.cap="Fig. 8: Median property price change for towns based on county and region", fig.align= "center"}
...
```{r, fig.cap="Fig. 9: Rate of price change over years for major towns", fig.align= "center"}
...
```{r, fig.cap="Fig. 10: Average property price vs Total sale price for four towns", fig.align= "center"}
